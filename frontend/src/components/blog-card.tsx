    ...
    return (
        <Link to = {`/blog/${id}`} >
            <div className="flex flex-col gap-2 w-full pb-4 border-b items-start justify-start">
                ...
                <div className=" text-sm opacity-80 w-fit rounded">
                    <span className="bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded me-2 shadow-md shadow-gray-200">
